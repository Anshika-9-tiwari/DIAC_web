...
export default function CorporateTestimonials() {
  ...
  return (
    <section
      id="reviews"
      className="py-14 md:py-16 bg-[#fbfcff] overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        {/* Subtext */}
        <p className="text-gray-500 max-w-2xl mb-10 md:mb-12 text-base">
        ...
        >
          <div className="flex">
            ...
            {testimonials.map((item, i) => (
              <div
                key={i}
                className="flex-[0_0_100%] sm:flex-[0_0_50%] lg:flex-[0_0_33.333%] min-w-0 px-2 md:px-3"
              >

                <div className="bg-white border border-gray-200 rounded-xl p-5 md:p-6 shadow-sm hover:shadow-lg transition duration-300 h-full min-h-[330px] flex flex-col">
                  ...
                  <div className="flex items-center gap-3 pt-4 mt-5 border-t border-gray-100">
                    ...
                    <div className="w-10 h-10 bg-[#801717] text-white rounded-full flex items-center justify-center shrink-0">
                      <UserRound size={18} />
                    </div>
